...
def pad(data: bytes) -> bytes:
    ...
    '''
    input_len = len(data)
    input_len_bytes = int_to_bytes(((input_len * 8) % (2 ** 64)))[:8]
...
if __name__ == '__main__':
    print(int_to_bytes(md4(b'')).hex().upper() == '31D6CFE0D16AE931B73C59D7E0C089C0')
    print(int_to_bytes(md4(b'a')).hex().upper() == 'bde52cb31de33e46245e05fbdbd6fb24'.upper())
    print(int_to_bytes(md4(b'abc')).hex().upper() == 'A448017AAF21D8525FC10AE87AA6729D')
    print(int_to_bytes(md4(b'message digest')).hex().upper() == 'D9130A8164549FE818874806E1C7014B')
    print(int_to_bytes(md4(b'abcdefghijklmnopqrstuvwxyz')).hex().upper() == 'D79E1C308AA5BBCDEEA8ED63DF412DA9')
    print(int_to_bytes(md4(b'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789')).hex().upper() == '043F8582F241DB351CE627E153E7F0E4')
    print(int_to_bytes(md4(b'12345678901234567890123456789012345678901234567890123456789012345678901234567890')).hex().upper() == 'E33B4DDC9C38F2199C3E7B164FCC0536')
